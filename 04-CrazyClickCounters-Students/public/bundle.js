...
/***/ function(module, exports, __webpack_require__) {
	...
	var Adder = __webpack_require__(160);
	var Multiplier = __webpack_require__(161);
	var Randomizer = __webpack_require__(162);
	var Imgr = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Panels/Imgr\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-md-3' },
						React.createElement(Adder, { clicks: this.state.clicks })
					),
					React.createElement(
						'div',
						{ className: 'col-md-3' },
						React.createElement(Multiplier, { clicks: this.state.clicks })
					),
					React.createElement(
						'div',
						{ className: 'col-md-3' },
						React.createElement(Randomizer, { clicks: this.state.clicks })
					),
					React.createElement(
						'div',
						{ className: 'col-md-3' },
						React.createElement(Imgr, { clicks: this.state.clicks })
					)
				)
			);
		}
