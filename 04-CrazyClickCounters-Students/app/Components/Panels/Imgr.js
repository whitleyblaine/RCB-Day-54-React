...
var Imgr = React.createClass({
	...
	getInitialState: function(){
		return {
			src: [	"https://danceswithfat.files.wordpress.com/2011/08/victory.jpg", 
	...
	// This is a custom React lifecycle event. In essence it gets triggered anytime a child component (in this case Imgr)
	// gets given a new prop from a parent (in this case Main)
	// Anytime Imgr receives a new click event it will trigger a new selection number to be chosen
	componentWillReceiveProps: function(){
		/* TODO select a random selection */
		this.setState({selection: Math.floor(Math.random() * (this.state.src).length)});
	},
		...
		return(
			...
			<div className="panel panel-default">
				...
				<div className="panel-body">
					...
					<img src={/*set a random image*/} width="100%"/>
